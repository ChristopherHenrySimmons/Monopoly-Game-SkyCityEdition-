...
namespace Monopoly
{
    ...
    public class Player : Trader
    {
        ...
        public bool IsInCasino { get; set; }            //If the player is in casino
        //CHANGEDCHANGED*CHANGED*CHANGED*CHANGED*CHANGED*
        ...
        //New casino
        public event EventHandler playerGoCasino;
